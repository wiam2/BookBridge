...
namespace BookBridge_backend.Migrations
{
    ...
    [Migration("20250124181427_InitailMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookBridge_backend.Models.Emprunt", b =>
                {
                    b.HasOne("BookBridge_backend.Models.Lecteur", "Lecteur")
                        .WithMany("Emprunts")
                        .HasForeignKey("LecteurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookBridge_backend.Models.Livre", "Livre")
                        .WithMany("Emprunts")
